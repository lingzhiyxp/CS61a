...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if this_point == 1:
            if_has_one = 1
        total_points = total_points + this_point
        num_rolls -= 1
    if if_has_one == 1:
        total_points = 1
    return total_points
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    single_diff = abs(player_score%10 - opponent_score%10)
    if single_diff == opponent_score//10 % 10:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    this_score0 = this_score1 = 0
    num_rolls_0 = num_rolls_1 = 0
    while score0 < goal and score1 < goal:
        if who == 0:
            num_rolls_0 = strategy0(score0, score1)
            if feral_hogs and abs(num_rolls_0 - this_score0) == 2:
                score0 += 3
            this_score0 = take_turn(num_rolls_0, score1, dice)
            score0 += this_score0
            if is_swap(score0, score1):
                score0, score1 = score1, score0
        else:
            num_rolls_1 = strategy1(score1, score0)
            if feral_hogs and abs(num_rolls_1 - this_score1) == 2:
                score1 += 3
            this_score1 = take_turn(num_rolls_1, score0, dice)
            score1 += this_score1
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    after_score = score + free_bacon(opponent_score)
    if is_swap(after_score, opponent_score):
        if after_score < opponent_score:
            return 0
        else:
            return num_rolls
    else:
...
def final_strategy(score, opponent_score):
    """The final strategy have to be a combination of the previous strategies.
    ...
    if score < opponent_score:
        ...
        if score - opponent_score >= 20:
            ...
            return swap_strategy(score, opponent_score, 6, 1)
    # END PROBLEM 12
